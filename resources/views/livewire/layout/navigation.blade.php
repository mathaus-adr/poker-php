    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" wire:navigate>
                        <x-bi-controller class="block h-9 w-auto fill-current text-gray-200"></x-bi-controller>
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48" class="border border-gray-600">
                   <x-menu-item title="{{__('Perfil')}}" wire:click="profile" icon="c-user"></x-menu-item>
                   <x-menu-item title="{{__('Recompensas diárias')}}" wire:click="profile" icon="s-bell-alert" ></x-menu-item>
                   <x-menu-item title="{{__('Logout')}}" wire:click="logout"></x-menu-item>
                </x-dropdown>
            </div>
